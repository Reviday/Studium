 ...
 */
@WebServlet("/pstudy/studyAdd")
public class PstudyAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PstudyAddServlet() {
        super();
...
//				+File.separator+"Studium"+File.separator+"web"+File.separator+"upload"+File.separator+"pstudy";
		...
		int pStudyTeacherno=Integer.parseInt(mr.getParameter("p_teacherno"));
	      ...
	      p.setpLike(like);
	      p.setpStudyTeacherno(pStudyTeacherno);
