...
/**
 * Servlet implementation class AdminBoardStoryDeleteServlet
 */
@WebServlet("/admindeleteStory")
public class AdminBoardStoryDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardStoryDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String URLmapping="/admindeleteStory"; // 패턴을 넘겨주기 위한 변수
