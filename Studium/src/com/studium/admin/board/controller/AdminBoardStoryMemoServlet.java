...
/**
 * Servlet implementation class AdminBoardStoryMemoServlet
 */
@WebServlet("/adminMemoStory")
public class AdminBoardStoryMemoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardStoryMemoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String memo = service.storyMemo(storyNo);
