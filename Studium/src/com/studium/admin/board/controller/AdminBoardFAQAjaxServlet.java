...
/**
 * Servlet implementation class AdminBoardFAQAjaxServlet
 */
@WebServlet("/AdminBoardAjaxFAQ")
public class AdminBoardFAQAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardFAQAjaxServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String URLmapping="/AdminBoardAjaxFAQ"; // 패턴을 넘겨주기 위한 변수
