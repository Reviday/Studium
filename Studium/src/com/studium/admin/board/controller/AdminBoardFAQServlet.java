...
/**
 * Servlet implementation class AdminBoardFAQServlet
 */
@WebServlet("/AdminBoardFAQ")
public class AdminBoardFAQServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardFAQServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String URLmapping="/AdminBoardFAQ"; // 패턴을 넘겨주기 위한 변수
		...
		request.getRequestDispatcher("/views/adminBoard/FAQ.jsp")
