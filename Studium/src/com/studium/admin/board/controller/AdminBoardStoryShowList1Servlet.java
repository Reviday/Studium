...
/**
 * Servlet implementation class AdminBoardStoryShowList1Servlet
 */
@WebServlet("/showStoryList1")
public class AdminBoardStoryShowList1Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardStoryShowList1Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginMember != null && loginMember.getMemCode() == 'M') {
			...
			String URLmapping="/showStoryList1"; // 패턴을 넘겨주기 위한 변수
			AdminPaginationTemplate pt=new AdminPaginationTemplate(request, totalData, URLmapping, method); // 페이징 처리 
			List<Story> list=service.selectStoryList(cPage,pt.getNumPerPage());
