...
/**
 * Servlet implementation class AdminBoardInsertFAQServlet
 */
@WebServlet("/AdminBoardInsertFAQ")
public class AdminBoardInsertFAQServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBoardInsertFAQServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = service.insertQnA(type, title, content);
		int totalData=service.selectCountFAQ();
		String URLmapping="/AdminBoardInsertFAQ"; // 패턴을 넘겨주기 위한 변수
