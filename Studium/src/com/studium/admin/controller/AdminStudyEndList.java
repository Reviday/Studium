...
/**
 * Servlet implementation class AdminStudyEndList
 */
@WebServlet("/endStudyList")
public class AdminStudyEndList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminStudyEndList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalData=service.selectCountEndStudyList();
		String URLmapping="/endStudyList"; // 패턴을 넘겨주기 위한 변수
		AdminPaginationTemplate pt=new AdminPaginationTemplate(request, totalData, URLmapping, method); // 페이징 처리 

		List<Pstudy> list=service.selectEndStudyList(cPage,pt.getNumPerPage());
