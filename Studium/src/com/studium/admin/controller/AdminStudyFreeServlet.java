...
/**
 * Servlet implementation class AdminStudyFreeServlet
 */
@WebServlet("/AdminStudyFreeManage")
public class AdminStudyFreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminStudyFreeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String URLmapping="/AdminStudyFreeManage"; // 패턴을 넘겨주기 위한 변수
		PaginationTemplate pt=new PaginationTemplate(request, totalData, URLmapping); // 페이징 처리 
		List<Fstudy> list=service.selectFreeStudyPlayList(pt.getcPage(),pt.getNumPerPage());
		...
		request.getRequestDispatcher("/views/admin/FreeStudyList.jsp")
