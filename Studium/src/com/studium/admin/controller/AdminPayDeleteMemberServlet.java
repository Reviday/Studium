...
/**
 * Servlet implementation class AdminPayDeleteMemberServlet
 */
@WebServlet("/deletePayMember")
public class AdminPayDeleteMemberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminPayDeleteMemberServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new AdminService().deletePayMember(memNo);
		...
		String URLmapping="/deletePayMember"; // 패턴을 넘겨주기 위한 변수
		AdminPaginationTemplate pt=new AdminPaginationTemplate(request, totalData, URLmapping, method); // 페이징 처리 

		List<PayMember> list=service.selectPayMemberList(cPage,pt.getNumPerPage());
