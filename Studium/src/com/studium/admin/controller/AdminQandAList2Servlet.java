...
/**
 * Servlet implementation class AdminQandAList2Servlet
 */
@WebServlet("/AdminQandAList2")
public class AdminQandAList2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminQandAList2Servlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginMember != null && loginMember.getMemCode() == 'M') {
			...
			String URLmapping="/AdminQandAList2"; // 패턴을 넘겨주기 위한 변수
