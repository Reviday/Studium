...
/**
 * Servlet implementation class AdminPointManagePointUpServlet
 */
@WebServlet("/admin/memberPointUp")
public class AdminPointManagePointUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminPointManagePointUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginMember != null && loginMember.getMemCode() == 'M') {
			String point = request.getParameter("pointUp");
			String[] memberNo = request.getParameterValues("checkMember");
			String[] memName = request.getParameterValues("memName");
			String[] memEmail = request.getParameterValues("memEmail");
	
			AdminService service = new AdminService();
			
			service.pointUpContent(point, memberNo, memName, memEmail);
