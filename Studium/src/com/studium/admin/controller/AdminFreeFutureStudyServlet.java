...
/**
 * Servlet implementation class AdminFreeFutureStudyServlet
 */
@WebServlet("/futureFreeStudyList")
public class AdminFreeFutureStudyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeFutureStudyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalData=service.selectCountFutureFreeStudyList();
		String URLmapping="/futureFreeStudyList"; // 패턴을 넘겨주기 위한 변수
		AdminPaginationTemplate pt=new AdminPaginationTemplate(request, totalData, URLmapping, method); // 페이징 처리 

		List<Fstudy> list=service.selectFutureFreeStudyList(cPage,pt.getNumPerPage());
		...
		request.getRequestDispatcher("/views/admin/commonFreeStudyList.jsp")
