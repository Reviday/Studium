...
/**
 * Servlet implementation class AdminStudyFutureList
 */
@WebServlet("/futureStudyList")
public class AdminStudyFutureList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminStudyFutureList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalData=service.selectCountFutureStudyList();
		String URLmapping="/futureStudyList"; // 패턴을 넘겨주기 위한 변수
		AdminPaginationTemplate pt=new AdminPaginationTemplate(request, totalData, URLmapping, method); // 페이징 처리 

		List<Pstudy> list=service.selectFutureStudyList(cPage,pt.getNumPerPage());
