...
/**
 * Servlet implementation class AdminPSManageServlet
 */
@WebServlet("/AdminPSManage")
public class AdminPSManageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminPSManageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginMember != null && loginMember.getMemCode() == 'M') {
			...
			String URLmapping="/AdminPSManage"; // 패턴을 넘겨주기 위한 변수
			PaginationTemplate pt=new PaginationTemplate(request, totalData, URLmapping); // 페이징 처리 
			List<LeaderAdd> list=service.selectLeaderPSList(pt.getcPage(),pt.getNumPerPage());
			...
			request.getRequestDispatcher("/views/admin/leaderPSList.jsp")
