...
/**
 * Servlet implementation class AdminFreeStudyEndServlet
 */
@WebServlet("/endFreeStudyList")
public class AdminFreeStudyEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeStudyEndServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalData=service.selectCountEndFreeStudyList();
		String URLmapping="/endFreeStudyList"; // 패턴을 넘겨주기 위한 변수
		AdminPaginationTemplate pt=new AdminPaginationTemplate(request, totalData, URLmapping, method); // 페이징 처리 

		List<Fstudy> list=service.selectEndFreeStudyList(cPage,pt.getNumPerPage());
