...
/**
 * Servlet implementation class AdminStudyManageServlet
 */
@WebServlet("/AdminStudyManage")
public class AdminStudyManageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminStudyManageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String URLmapping="/AdminStudyManage"; // 패턴을 넘겨주기 위한 변수
		PaginationTemplate pt=new PaginationTemplate(request, totalData, URLmapping); // 페이징 처리 
		List<Pstudy> list=service.selectStudyPlayList(pt.getcPage(),pt.getNumPerPage());
		...
		request.getRequestDispatcher("/views/admin/StudyList.jsp")
