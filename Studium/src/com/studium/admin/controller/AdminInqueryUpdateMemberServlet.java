...
public class AdminInqueryUpdateMemberServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pt.setQueryString("gradeList", "allGrade");
		pt.setQueryString("statusList", "allStatus");
		List<Member> list=service.selectMemberSearchList(pt.getcPage(),pt.getNumPerPage(), "allGrade", "allStatus");
		...
		request.setAttribute("status", "allStatus");
