...
/**
 * Servlet implementation class AdminInqueryList2Servlet
 */
@WebServlet("/inqueryList2")
public class AdminInqueryList2Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminInqueryList2Servlet() {
		super();
