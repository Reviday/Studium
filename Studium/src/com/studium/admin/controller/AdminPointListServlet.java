...
/**
 * Servlet implementation class AdminPointListServlet
 */
@WebServlet("/inqueryList3")
public class AdminPointListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminPointListServlet() {
        super();
