...
/**
 * Servlet implementation class AdminPointManageServlet
 */
@WebServlet("/AdminPointManage")
public class AdminPointManageServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminPointManageServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String URLmapping="/AdminPointManage"; // 패턴을 넘겨주기 위한 변수
