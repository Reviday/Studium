...
/**
 * Servlet implementation class AdminLoginLogSearchServlet
 */
@WebServlet("/LoginLogSearch")
public class AdminLoginLogSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminLoginLogSearchServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginMember != null && loginMember.getMemCode() == 'M') {
			...
			int totalData=service.selectCountLoginLogSearch(memberName);
			String URLmapping="/LoginLogSearch"; // 패턴을 넘겨주기 위한 변수
			...
			List<MemberLoginLog> list=service.selectCountLoginLogSearch(cPage,pt.getNumPerPage(), memberName);
			...
			request.getRequestDispatcher("/views/admin/commonLoginLog.jsp")
