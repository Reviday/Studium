...
/**
 * Servlet implementation class AdminFreeStudyIngServlet
 */
@WebServlet("/ingFreeStudyList")
public class AdminFreeStudyIngServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminFreeStudyIngServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int totalData=service.selectCountFreeStudy();
		String URLmapping="/ingFreeStudyList"; // 패턴을 넘겨주기 위한 변수
		AdminPaginationTemplate pt=new AdminPaginationTemplate(request, totalData, URLmapping, method); // 페이징 처리 

		List<Fstudy> list=service.selectFreeStudyPlayList(cPage,pt.getNumPerPage());
