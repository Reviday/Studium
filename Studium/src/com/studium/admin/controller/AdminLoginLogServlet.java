...
/**
 * Servlet implementation class AdminLoginLogServlet
 */
@WebServlet("/AdminLoginLog")
public class AdminLoginLogServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginMember != null && loginMember.getMemCode() == 'M') {
			...
			int totalData=service.selectCountLoginLog();
			String URLmapping="/AdminLoginLog"; // 패턴을 넘겨주기 위한 변수
			...
			request.getRequestDispatcher("/views/admin/LoginLog.jsp")
