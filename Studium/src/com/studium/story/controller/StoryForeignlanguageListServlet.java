 ...
 */
@WebServlet("/story1")
public class StoryForeignlanguageListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StoryForeignlanguageListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	slist=service.selectForeignlanguageList();
		...
		request.getRequestDispatcher("/views/story/storyForeignLanguageReview.jsp")
