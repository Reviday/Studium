...
public class QuestionMadangCmtDao {
private Properties prop=new Properties();
	
	public QuestionMadangCmtDao() {
		String path=FreeMadangDao.class.getResource("/sql/madang/questionmadangcmt-query.properties").getPath();
		try {
	...
	public List<QuestionMadangCmt> selectCmtList(Connection conn, int madangNo, int cPage, int numPerPage) {
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		List<QuestionMadangCmt> list = new ArrayList<QuestionMadangCmt>();
	...
	public int insertComment(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int insertReply(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
		// 대댓글을 추가하기 위한 SQL문
	...
	public int updateReplySort(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int updateCmtReply(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int updateComment(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int deleteComment(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int autoDeleteReply(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int updateReply(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int deleteReply(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int updateReplySortOnDelete(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
		// 대댓글 추가시, 기존의 댓글들의 SORT 값을 증가시키기 위한 UPDATE 문
	...
	public int checkForReply(Connection conn, QuestionMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
