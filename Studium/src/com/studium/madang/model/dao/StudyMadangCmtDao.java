...
public class StudyMadangCmtDao {

private Properties prop=new Properties();
	
	public StudyMadangCmtDao() {
		String path=FreeMadangDao.class.getResource("/sql/madang/studymadangcmt-query.properties").getPath();
		try {
	...
	public List<StudyMadangCmt> selectCmtList(Connection conn, int madangNo, int cPage, int numPerPage) {
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		List<StudyMadangCmt> list = new ArrayList<StudyMadangCmt>();
		...
		try {
			...
			rs=pstmt.executeQuery();
			while(rs.next()) {
				StudyMadangCmt cmt=new StudyMadangCmt();
	...
	public int insertComment(Connection conn, StudyMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int insertReply(Connection conn, StudyMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
		// 대댓글을 추가하기 위한 SQL문
	...
	public int updateReplySort(Connection conn, StudyMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int updateCmtReply(Connection conn, StudyMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
