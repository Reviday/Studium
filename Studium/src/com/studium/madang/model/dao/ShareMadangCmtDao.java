...
public class ShareMadangCmtDao {
	...
	public int updateComment(Connection conn, ShareMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int deleteComment(Connection conn, ShareMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int autoDeleteReply(Connection conn, ShareMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int updateReply(Connection conn, ShareMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int deleteReply(Connection conn, ShareMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
	...
	public int updateReplySortOnDelete(Connection conn, ShareMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
		// 대댓글 추가시, 기존의 댓글들의 SORT 값을 증가시키기 위한 UPDATE 문
	...
	public int checkForReply(Connection conn, ShareMadangCmt cmt) {
		PreparedStatement pstmt=null;
		int result=0;
