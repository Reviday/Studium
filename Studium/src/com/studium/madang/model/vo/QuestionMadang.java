...
public class QuestionMadang extends Madang{
	...
	public QuestionMadang() {
		// TODO Auto-generated constructor stub
	}

	public QuestionMadang(int madangNo, int madangParent, int madangOrder, int madangWriterUid,
			String madangWriterEmail, String madangWriterName, String madangTitle, String madangContent,
			String madangMainCategory, String madangCategory, String madangSubCategory,
			Timestamp madangRegisterDatetime, String madangRegisterIp, Timestamp madangUpdatedDatetime,
			String madangUpdatedIp, int madangRecCount, int madangRepCount, int madangReadCount,
	...
	public String toString() {
		return "QuestionMadang [madangNo=" + madangNo + ", madangParent=" + madangParent + ", madangOrder="
				+ madangOrder + ", madangWriterUid=" + madangWriterUid + ", madangWriterEmail=" + madangWriterEmail
