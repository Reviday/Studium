...
public class StudyMadangCmt {
	...
	public StudyMadangCmt() {
		// TODO Auto-generated constructor stub
	}


	public StudyMadangCmt(int cmtNo, int cmtParent, int cmtSort, int cmtMadangNo, String cmtContent, char cmtReply,
	...
	public String toString() {
		return "StudyMadangCmt [cmtNo=" + cmtNo + ", cmtParent=" + cmtParent + ", cmtSort=" + cmtSort + ", cmtMadangNo="
