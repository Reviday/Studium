...
public class ShareMadang extends Madang {
	...
	public ShareMadang(int madangNo, int madangParent, int madangOrder, int madangWriterUid, String madangWriterEmail,
			...
			int madangReadCount, int madangForkCount, char madangFilePresence, char madangImgPresence,
			char madangStatus, String profilePath) {
		super();
	...
	public String toString() {
		return "ShareMadang [madangNo=" + madangNo + ", madangParent=" + madangParent + ", madangOrder=" + madangOrder
				...
				+ madangRepCount + ", madangReadCount=" + madangReadCount + ", madangForkCount=" + madangForkCount
