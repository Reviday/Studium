...
public class BoastMadangCmt {
	...
	public BoastMadangCmt() {
		// TODO Auto-generated constructor stub
	}

	public BoastMadangCmt(int cmtNo, int cmtParent, int cmtSort, int cmtMadangNo, String cmtContent, char cmtReply,
	...
	public String toString() {
		return "BoastMadangCmt [cmtNo=" + cmtNo + ", cmtParent=" + cmtParent + ", cmtSort=" + cmtSort + ", cmtMadangNo="
