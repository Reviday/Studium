...
public class ShareMadangCmt {
	...
	public ShareMadangCmt() {
		// TODO Auto-generated constructor stub
	}

	public ShareMadangCmt(int cmtNo, int cmtParent, int cmtSort, int cmtMadangNo, String cmtContent, char cmtReply,
	...
	public String toString() {
		return "ShareMadangCmt [cmtNo=" + cmtNo + ", cmtParent=" + cmtParent + ", cmtSort=" + cmtSort + ", cmtMadangNo="
