...
/**
 * Servlet implementation class QuestionMadangAddReplyServlet
 */
@WebServlet("/madang/questionAddReply")
public class QuestionMadangAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionMadangAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new QuestionMadangCmtService().insertReply(cmt);
