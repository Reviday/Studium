...
/**
 * Servlet implementation class StudyMadangAddReplyServlet
 */
@WebServlet("/madang/studyAddReply")
public class StudyMadangAddReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StudyMadangAddReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new StudyMadangCmtService().insertReply(cmt);
