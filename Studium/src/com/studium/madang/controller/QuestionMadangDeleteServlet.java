...
/**
 * Servlet implementation class QuestionMadangDeleteServlet
 */
@WebServlet("/madang/questionMadangDelete")
public class QuestionMadangDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionMadangDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 
		int result=new QuestionMadangService().deleteMadang(bm);
		...
		String view="/";
		if(result>0) {
			view="/madang/questionMadangList?cPage="+cPage;
		} else if(result<0) {
			String msg="권한이 없습니다.";
