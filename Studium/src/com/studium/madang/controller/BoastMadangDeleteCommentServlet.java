...
/**
 * Servlet implementation class BoastMadangDeleteCommentServlet
 */
@WebServlet("/madang/boastDeleteComment")
public class BoastMadangDeleteCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoastMadangDeleteCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new BoastMadangCmtService().deleteComment(cmt);
