...
/**
 * Servlet implementation class FreeMadangUpdateCommentServlet
 */
@WebServlet("/madang/freeUpdateComment")
public class FreeMadangUpdateCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeMadangUpdateCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new FreeMadangCmtService().updateComment(cmt);
