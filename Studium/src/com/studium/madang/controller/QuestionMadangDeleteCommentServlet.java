...
/**
 * Servlet implementation class QuestionMadangDeleteCommentServlet
 */
@WebServlet("/madang/questionDeleteComment")
public class QuestionMadangDeleteCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionMadangDeleteCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new QuestionMadangCmtService().deleteComment(cmt);
