 ...
 */
@WebServlet("/madang/questionUpdateComment")
public class QuestionMadangUpdateCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionMadangUpdateCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new QuestionMadangCmtService().updateComment(cmt);
