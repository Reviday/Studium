...
/**
 * Servlet implementation class ShareMadangUpdateCommentServlet
 */
@WebServlet("/madang/shareUpdateComment")
public class ShareMadangUpdateCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShareMadangUpdateCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new ShareMadangCmtService().updateComment(cmt);
