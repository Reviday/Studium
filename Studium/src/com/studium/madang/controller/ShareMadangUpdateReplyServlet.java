...
/**
 * Servlet implementation class ShareMadangUpdateReplyServlet
 */
@WebServlet("/madang/shareUpdateReply")
public class ShareMadangUpdateReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShareMadangUpdateReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new ShareMadangCmtService().updateReply(cmt);
