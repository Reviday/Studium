...
/**
 * Servlet implementation class QuestionMadangWriterEndServlet
 */
@WebServlet("/madang/question/writeEnd")
public class QuestionMadangWriterEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionMadangWriterEndServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		QuestionMadang bm=new QuestionMadang();
		...
		int madangNo=new QuestionMadangService().insertMadang(bm);
		...
		String view="/";
		if(madangNo>0) {
			view="/madang/questionMadangView?madangNo="+madangNo+"&cPage=1"+
