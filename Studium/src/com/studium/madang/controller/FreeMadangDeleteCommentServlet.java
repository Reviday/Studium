...
/**
 * Servlet implementation class FreeMadangDeleteCommentServlet
 */
@WebServlet("/madang/freeDeleteComment")
public class FreeMadangDeleteCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeMadangDeleteCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new FreeMadangCmtService().deleteComment(cmt);
