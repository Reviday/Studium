...
/**
 * Servlet implementation class FreeMadangUpdateReplyServlet
 */
@WebServlet("/madang/freeUpdateReply")
public class FreeMadangUpdateReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeMadangUpdateReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new FreeMadangCmtService().updateReply(cmt);
