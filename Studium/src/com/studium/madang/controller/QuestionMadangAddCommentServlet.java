...
/**
 * Servlet implementation class QuestionMadangAddCommentServlet
 */
@WebServlet("/madang/questionAddComment")
public class QuestionMadangAddCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuestionMadangAddCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2차 로그인 체크. 
		if(!new LoginCheck().doLoginCheck(request, response, 1006)) return;
		...
		int result=new QuestionMadangCmtService().insertComment(cmt);
