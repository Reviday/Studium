 ...
 */
@WebServlet("/madang/boastUpdateReply")
public class BoastMadangUpdateReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoastMadangUpdateReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new BoastMadangCmtService().updateReply(cmt);
