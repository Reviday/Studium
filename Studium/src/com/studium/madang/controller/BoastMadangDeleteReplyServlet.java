...
/**
 * Servlet implementation class BoastMadangDeleteReplyServlet
 */
@WebServlet("/madang/boastDeleteReply")
public class BoastMadangDeleteReplyServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoastMadangDeleteReplyServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result=new BoastMadangCmtService().deleteReply(cmt);
