...
<table class="inqueryTable">
	...
	<tr>
		...
		<td>
			...
			<!-- onsubmit="return delete_validate();"> --> <input type="hidden"
			value="<%=m.getMemNo()%>" name="memNo" class="memNo"> <input
			type="button" value="탈퇴" class="deleteSubmit"
			onclick="deleteMember();"> <!-- </form> -->
		</td>
	</tr>
	<%
		}
