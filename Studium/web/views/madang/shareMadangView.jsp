									...
									<td><a href="#" class="b like_btn">좋아요</a>
										<div class="btn_module">
											<a href="#" class="btn_cnt" aria-pressed="false"> <img
												...
												alt=""> <em class="like_count"><%=sm.getMadangRecCount() %></em>
											</a>
										</div></td>
								</tr>
							</tbody>
						                                ...
						                                <div class="rp_general cng-container">
						                                    <div class="cng-header">
                                                                ...
                                                                %>
			 			                                        ...
			 			                                        <span class="timeago dt-published ie-dotum" title="">
			 			                                        	<a href="#" class="m-tcol-c ablock" id="edit_cmt_<%=cmt.getCmtNo()%>"
			 			                                        		onclick="fn_deleteComment('<%=cmt.getCmtNo()%>','<%=loginMember!=null?loginMember.getMemNo():null%>', 'share', '<%=request.getContextPath() %>','<%=sm.getMadangNo()%>','<%=loginMember!=null?loginMember.getMemNo():""%>','<%=cPage%>', '<%=choice%>', '<%=choiceSub%>'); return false;">
			 			                                        		삭제</a>
			 			                                        </span>
			 			                                        <span class="m-tcol-c" style="opacity: 0.3">|</span>
			 			                                        <%
                                                            ...
                                                            <div class="rp_admin cng-container">
                                                                <div class="cng-header">
                                                                    ...
                                                                    %>
				 			                                        ...
				 			                                        <span class="timeago dt-published ie-dotum" title="">
				 			                                        	<a href="#" class="m-tcol-c ablock" id="edit_cmt_<%=cmt.getCmtNo()%>"
				 			                                        		onclick="fn_deleteReply('<%=cmt.getCmtNo()%>','<%=cmt.getCmtParent() %>','<%=cmt.getCmtSort()%>','<%=loginMember!=null?loginMember.getMemNo():null%>', 'share', '<%=request.getContextPath() %>','<%=sm.getMadangNo()%>','<%=loginMember!=null?loginMember.getMemNo():""%>','<%=cPage%>', '<%=choice%>', '<%=choiceSub%>'); return false;">
				 			                                        		삭제</a>
				 			                                        </span>
				 			                                        <%
                                                                    	} else {
