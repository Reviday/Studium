        ...
        <article class="allhugi">
            ...
            <div class="review">
                ...
                <div id="mysidenav" class="sidenav">
                        ...
                        <a href="story.jsp">입문후기</a>
                        <a href="story1.jsp">초급후기</a>
                        <a href="story2.jsp">중급후기</a>
                        <a href="story3.jsp">고급후기</a>
                    ...
                    <script>
                        function openNav() {
                            document.getElementById('mysidenav').style.width = '170px',style.height='300px';
                        }
                        function closeNav() {
