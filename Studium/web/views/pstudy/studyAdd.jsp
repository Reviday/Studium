                                    ...
                                    <FORM NAME="pstudyfrm1" ACTION="<%=request.getContextPath()%>/pstudy/studyAdd"
                                        ...
                                        <td align="center">
                                            <table width="100%" border="0" cellspacing="1" cellpadding="7"
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="76%" align="left" bgcolor="#FFFFFF"><INPUT TYPE="text"
                                                            SIZE="10" MAXLENGTH="7" NAME="p_price" required
										...
										<% } } %>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="76%" align="left" bgcolor="#FFFFFF">
                                                        <INPUT TYPE="text" NAME="p_teachername" size=50 required /></td>
                                                </tr>
                                                  <tr>
                                                    <td width="24%" align="left" bgcolor="#EEEEEE">강사번호</td>
                                                    <td width="76%" align="left" bgcolor="#FFFFFF" >
                                                    
                                                       <input type="number" id="p_teacherno" name="p_teacherno" required/>
